...
#            print(f"!!!! Position_list: {self.position_list}")
            ...
            if self.num_last_moves>=len(self.unvisited):
                ...
                for unvisited in self.unvisited:
                    if self.current_customer_list[unvisited][self.index_dist_to_truck] < best_dist:
                        best_dist = self.current_customer_list[unvisited][self.index_dist_to_truck]
                        best_index = unvisited
